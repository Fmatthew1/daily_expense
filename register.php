...
if(isset($_POST['submit'])) {
  ...
  if(mysqli_num_rows($result) > 0){
    ...
    $query = "SELECT MAX(ID) as max_id FROM tbluser";
    $result = mysqli_query($con, $query);
    $row = mysqli_fetch_assoc($result);
    $cnt = $row['max_id'] + 1;

    $insert_query = "INSERT INTO tbluser (ID, FullName, MobileNumber, Email, Password) VALUES ('$cnt','$fname', '$mobno', '$email', '$password')";
					...
					<form role="form" action="" method="post">
						...
						<fieldset>
                           ...
                           <div class="form-group">
							...
							<div class="form-group">
								<input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Mobile Number" maxlength="11" pattern="[0-9]{10}" required="true">
							</div>
							<div class="form-group">
