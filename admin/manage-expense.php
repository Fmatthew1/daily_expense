...
if (isset($_GET['id'])) {
    ...
    if (mysqli_query($con, $sql)) {
        ...
        $msg = "Error deleting Expense: " . mysqli_error($con);
    }
}
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<tr><th>SN</th><th>Item</th><th>Cost</th><th>Category</th><th>Edit</th><th>Delete</th></tr>";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='edit_expense.php?id=" . $row["ID"] . "'>Edit</a></td>";
		echo '<td><a href="manage-expense.php?id=' . $row['ID'] . '" onclick="return confirm(\'Are you sure you want to delete this expense?\')">Delete</a></td>';
