...
$query=mysqli_query($con,"select admin_email from tbladmin where admin_id='$id' and   admin_password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbladmin set admin_password='$newpassword' where admin_id='$id' and and admin_email = '$email' ");
...
$ret=mysqli_query($con,"select * from tbladmin where admin_id='$id' and admin_email = '$email'");
$cnt=1;
